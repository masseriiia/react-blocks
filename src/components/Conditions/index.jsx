            ...
            <div className="conditions__blocks">
                ...
                <div className="conditions__second-block">
                    <div className="conditions__item-2">
                        ...
                        <h3 className="conditions__item-title">Програма дискреційних заохочень Бізнес Плюс⁺</h3>
                        <p className="conditions__item-descr">Додаткові винагороди: виконуйте умови програми, розвивайте стабільний бізнес та відкривайте нові переваги співпраці з Amway!</p>
                    </div>
                </div>
            </div>
        </section>
